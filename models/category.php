...
class Category extends Model{
    ...
    public function getByAlias($alias){
        ...
        $sql = "select * from term_taxonomy tax join terms t on tax.term_id = t.term_id where tax.taxonomy like 'category' and t.alias = '{$alias}' limit 1";
    ...
    public function getById($id){
        $id = (int)$id;
        $sql = "select * from term_taxonomy tax join terms t on tax.term_id = t.term_id where tax.taxonomy like 'category' and t.term_id = '{$id}' limit 1";
        $result = $this->db->query($sql);
        return isset($result[0]) ? $result[0] : null;
    }
